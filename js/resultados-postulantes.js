...
async function mostrarPostulantes() {
  ...
  const res = await fetch('backend/get_postulantes.php?' + params.toString());
  ...
  `).join('') : '<tr><td colspan="7" style="text-align:center; color:#64748b; font-style:italic; background:#fff;">No hay postulantes que cumplan con los filtros.</td></tr>';
}
